...
export const UseContext = () => {
  ...
  return (
    <div className="w-full max-w-6xl mx-auto p-4 sm:p-6 md:p-8 font-sans animate-in slide-in-from-right-4 duration-700">
      {/* Hero Section */}
      <div className="relative overflow-hidden bg-linear-to-br from-purple-900 to-indigo-950 rounded-2xl sm:rounded-3xl p-6 sm:p-8 md:p-10 lg:p-12 mb-8 sm:mb-10 md:mb-12 text-white shadow-2xl">
        ...
        <div className="relative z-10 max-w-3xl">
          ...
          <p className="text-sm sm:text-base md:text-lg lg:text-xl text-purple-100 leading-relaxed mb-6 sm:mb-8">
          ...
          <button
            onClick={() => navigate("/usecontext/darklightmode")}
            className="bg-white text-purple-900 px-6 sm:px-8 py-2 sm:py-3 rounded-2xl font-bold hover:bg-purple-50 transition-all flex items-center gap-2 shadow-xl active:scale-95 text-sm sm:text-base"
          >
            Lihat Demo Transmisi{" "}
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6 mb-8 sm:mb-10 md:mb-12">
        {features.map((item, idx) => (
          <div
            key={idx}
            className={`p-4 sm:p-6 md:p-8 rounded-2xl sm:rounded-3xl border-2 ${item.color} shadow-sm hover:shadow-lg transition-all group`}
          >
      ...
      {/* Visual Mental Model */}
      <div className="bg-white border-3 border-slate-100 rounded-2xl sm:rounded-3xl md:rounded-[2.5rem] p-6 sm:p-8 md:p-10 shadow-xl overflow-hidden">
        <h2 className="text-lg sm:text-xl md:text-2xl font-bold mb-6 sm:mb-8 md:mb-10 text-gray-900 flex items-center gap-2 sm:gap-3 italic">
          <Zap className="text-purple-600 w-5 h-5 sm:w-6 sm:h-6" /> Alur Data:
          Dulu vs Sekarang
        </h2>
      ...
      {/* Implementation Note */}
      <div className="mt-8 sm:mt-10 md:mt-12 bg-slate-900 rounded-2xl sm:rounded-3xl md:rounded-[2.5rem] p-6 sm:p-8 md:p-10 text-white relative overflow-hidden">
