...
import { AuthLab } from "./hooks-lab/useContext/AuthLab";
import { LanguageMode } from "./hooks-lab/useContext/LanguageMode";
  ...
  return (
    <div>
      <Routes>
        ...
        <Route path="/usecontext/authcontext" element={<AuthLab />} />
