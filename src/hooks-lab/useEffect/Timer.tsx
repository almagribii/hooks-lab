  ...
  return (
    <div className="w-full max-w-6xl mx-auto p-8 font-sans">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
        ...
        <div className="bg-linear-to-br from-rose-50 via-rose-100 to-rose-50 border-3 border-rose-400 rounded-3xl p-8 shadow-2xl">
          <div className="flex items-center gap-3 mb-6">
            ...
            ></div>
            <h2 className="text-3xl font-bold text-rose-900">Live Timer</h2>
          </div>
          ...
          <div className="bg-white rounded-2xl p-10 mb-6 shadow-lg border-2 border-rose-200">
            ...
            <div className="text-8xl font-black text-rose-600 mb-4 text-center tabular-nums">
              {seconds}s
            </div>
            <div className="flex gap-3 mt-6">
              ...
              <button
                onClick={resetTimer}
                className="px-6 py-3 bg-gray-200 hover:bg-gray-300 text-gray-700 rounded-xl font-bold transition-all active:scale-95"
              >
                Reset
              </button>
            </div>
          ...
          <div className="bg-rose-100 rounded-xl p-5 border-2 border-rose-300">
        ...
        <div className="bg-linear-to-br from-amber-50 via-amber-100 to-amber-50 border-3 border-amber-400 rounded-3xl p-8 shadow-2xl">
          <div className="flex items-center gap-3 mb-6">
            <div className="w-6 h-6 bg-amber-500 rounded-full"></div>
            <h2 className="text-3xl font-bold text-amber-900">Cleanup Trace</h2>
          </div>

          <div className="bg-slate-900 rounded-2xl p-6 mb-6 shadow-lg border-2 border-amber-200 min-h-300px font-mono text-sm">
          ...
          <div className="bg-amber-100 rounded-xl p-5 border-2 border-amber-300 space-y-3">
      ...
      <div className="bg-slate-800 rounded-3xl p-8 shadow-xl text-white">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
          <div>
            <div className="text-amber-400 text-3xl mb-2 font-bold">1</div>
            <p className="text-sm text-gray-300 italic">"Effect Setup"</p>
            <p className="text-sm font-medium mt-1">
              Memasang interval saat komponen muncul.
            </p>
          </div>
          <div>
            <div className="text-amber-400 text-3xl mb-2 font-bold">2</div>
            <p className="text-sm text-gray-300 italic">"Execution"</p>
            <p className="text-sm font-medium mt-1">
              Timer berjalan secara independent di background.
            </p>
          </div>
          <div>
            <div className="text-amber-400 text-3xl mb-2 font-bold">3</div>
            <p className="text-sm text-gray-300 italic">"Cleanup"</p>
            <p className="text-sm font-medium mt-1">
