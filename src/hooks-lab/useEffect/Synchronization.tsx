  ...
  return (
    <div className="w-full max-w-6xl mx-auto p-8 font-sans">
      <div className="mb-12 flex flex-col items-center text-center">
        ...
        <h1 className="text-5xl font-black text-slate-900 mb-3 tracking-tighter leading-none">
          useEffect{" "}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 mb-12">
        {/* LEFT: INPUT SOURCE */}
        <div className="lg:col-span-2 bg-white border-2 border-slate-100 rounded-[3rem] p-10 shadow-xl shadow-slate-100 flex flex-col justify-between">
          <div>
          ...
          <div className="mt-10 p-5 bg-violet-50 rounded-2xl border border-violet-100 flex items-center gap-4">
            <RefreshCw
              className={`text-violet-600 ${isSyncing ? "animate-spin" : ""}`}
              size={20}
            />
        ...
        <div className="hidden lg:flex lg:col-span-1 items-center justify-center">
          <div className="flex flex-col items-center gap-2">
            ...
            <Zap className="text-fuchsia-500 fill-fuchsia-500" size={32} />
        ...
        <div className="lg:col-span-2 bg-slate-900 rounded-[3rem] p-10 shadow-2xl relative overflow-hidden flex flex-col justify-center">
          <div className="absolute top-0 right-0 p-8 opacity-10">
            <Layout size={150} className="text-white" />
          </div>
      ...
      {/* CODE EXPLAINER */}
      <div className="bg-slate-50 border-2 border-slate-100 rounded-[2.5rem] p-8 flex flex-col md:flex-row items-center gap-8 text-left">
        <div className="flex-1">
          <h4 className="font-black text-slate-800 text-lg mb-2 italic">
            How it works?
          </h4>
        ...
        <div className="flex-1 bg-white p-6 rounded-2xl shadow-inner border border-slate-100 font-mono text-[11px] text-slate-600">
          useEffect(() ={">"} {"{"} <br />
