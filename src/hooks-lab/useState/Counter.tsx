  ...
  return (
    <div className="w-full max-w-6xl mx-auto p-8">
      <div className="mb-8 flex flex-col items-center text-center">
        <h1 className="text-4xl font-bold text-gray-900 mb-2">Counter Demo dengan useState</h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
        ...
        <div className="bg-linear-to-br from-blue-50 via-blue-100 to-blue-50 border-3 border-blue-400 rounded-3xl p-8 shadow-2xl hover:shadow-3xl transition-shadow">
          ...
          <div className="bg-white rounded-2xl p-8 mb-6 shadow-lg border-2 border-blue-200">
            <p className="text-sm text-gray-500 font-semibold mb-3 uppercase tracking-wide">
              Current Count:
            </p>
            <div className="text-7xl font-black text-blue-600 mb-2 text-center">
              {count}
            </div>
          ...
          <button
            onClick={addValue}
            className="w-full bg-blue-500 hover:bg-blue-600 active:bg-blue-700 text-white font-bold py-4 px-6 rounded-xl transition-all duration-200 shadow-lg hover:shadow-xl active:scale-95 text-lg mb-4"
          >
            ➕ Increment Count
          </button>

          <div className="bg-blue-100 rounded-xl p-5 border-2 border-blue-300 space-y-2">
        ...
        <div className="bg-linear-to-br from-orange-50 via-orange-100 to-orange-50 border-3 border-orange-400 rounded-3xl p-8 shadow-2xl hover:shadow-3xl transition-shadow">
          <div className="flex items-center gap-3 mb-6">
          ...
          <div className="bg-white rounded-2xl p-8 mb-6 shadow-lg border-2 border-orange-200">
            ...
            <div className="text-7xl font-black text-orange-600 mb-2 text-center">
              0
            </div>
          ...
          <button
            onClick={addData}
            className="w-full bg-orange-500 hover:bg-orange-600 active:bg-orange-700 text-white font-bold py-4 px-6 rounded-xl transition-all duration-200 shadow-lg hover:shadow-xl active:scale-95 text-lg mb-4"
          >
            ➕ Increment Value
          </button>

          <div className="bg-orange-100 rounded-xl p-5 border-2 border-orange-300 space-y-2">
